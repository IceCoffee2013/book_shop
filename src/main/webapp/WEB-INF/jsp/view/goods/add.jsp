                    ...
                    <div class="col-lg-8">
                        <form class="form-horizontal" action="<c:url value="/goods/add.do" />" enctype="multipart/form-data" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="inputContact1" type="text" placeholder="" name="title"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="inputContact2" type="text" name="author"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="inputContact3" type="date" name="year" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputContact4" class="col-sm-2 control-label">Journal</label>
                                <div class="col-sm-10">
                                    <input id="inputContact4" type="text" name="journal" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputContact5" class="col-sm-2 control-label">Price</label>
                                <div class="col-sm-10">
                                    <input id="inputContact5" type="text" name="price"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="inputContact6" type="text" name="stock"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="inputContact7" type="text" name="venue"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
