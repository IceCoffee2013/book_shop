...
<table id="box-table-a" class="table table-hover">
            ...
            <tr>
                <td colspan="5" align="center">
                    <c:if test="${pagingVO.beginPage > 10}">
                        <a href="<c:url value="list.do?s=${param.s}&p=${pagingVO.beginPage-1}"/> ">Previous</a>
                    </c:if>
                    ...
                    <c:if test="${pagingVO.endPage < pagingVO.totalPageCount}">
                        <a href="<c:url value="list.do?s=${param.s}&p=${pagingVO.endPage + 1}"/> ">Next</a>
                    </c:if>
                </td>
            </tr>
        </c:otherwise>
    ...
    <tr>
        <td colspan="5">
            <a href="write.do?s=${param.s}">Write</a>
        </td>
    </tr>
