...
<div>
    <form id="frm" name="frm" action="<c:url value="/board/update.do" />" method="post" accept-charset="utf-8">
        ...
        title : <input type="text" name="title" size="100" value="${boardVO.title}"/><br/>
        ...
        <c:if test="${param.s == 'product'}">
                    ...
                    <c:otherwise>
                        <c:forEach var="list" items="${goodsVOList}">
                            <tr id="goods_id_${list.number}">
                                ...
                                <td class="popup_button"><button onclick="delGoods(${list.number})" name="${list.number}">choose</button></td>
            ...
            total_price : <input type="text" name="total_price" id="total_price" size="30" value="${boardVO.totalPrice}"/><br/>
