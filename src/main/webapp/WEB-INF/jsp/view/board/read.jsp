    ...
    <script type="text/javascript">
        ...
        j(document).ready(function(){
            ...
            j("a#addWish").on("click", function() {
            	var question = "Do you want to buy this in wishlist?";
...
<table>
    ...
    <tr>
        <td colspan="2">
            <input type="button" onclick="location.href='list.do?s=${param.s}&p=${param.p}'" value="back"/>
            <c:if test="${param.s != 'product'}">
                <input type="button" onclick="location.href='reply.do?s=${param.s}&p=${param.p}&parentBoardNumber=${boardVO.number}'" value="답변하기"/>
            </c:if>
            <input type="button" onclick="location.href='update.do?s=${param.s}&p=${param.p}&boardNumber=${boardVO.number}'" value="modify"/>
